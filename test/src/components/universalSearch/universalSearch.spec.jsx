...
describe('<UniversalSearch />', () => {
    ...
    it('should update chips and time preset when location changes', () => {
        ...
        expect(wrapper.find('Autosuggest').first().instance().props.uiState.chips.length).to.equal(1);
        wrapper.setProps({
        ...
        expect(wrapper.find('Autosuggest').first().instance().props.uiState.chips.length).to.equal(2);
    });
