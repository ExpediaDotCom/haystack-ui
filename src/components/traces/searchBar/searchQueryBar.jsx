                    ...
                    <form onSubmit={this.handleSubmit}>
                        ...
                        <div className="search-bar-pickers">
                            ...
                            <div className="search-bar-pickers_submit">
                                <button
                                    className="btn btn-primary btn-lg traces-search-button"
                                    type="submit"
                ...
                <section>
                    { (uiState.displayErrors.fieldError || uiState.displayErrors.timeWindowError)
                        ? <div className="traces-error-message">
                            {uiState.displayErrors.fieldError ?
                                <div className="traces-error-message_item">Invalid query, expected format is
                                    <span className="traces-error-message__code"> tag1=value1 tag2=value2 [...]</span>
                                </div> : null}
                            {uiState.displayErrors.timeWindowError ?
                                <div className="traces-error-message_item">Invalid date</div> : null}
                        </div>
                        : null
                    }
                </section>
