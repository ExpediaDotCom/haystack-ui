    ...
    <footer className="primary-footer">
        <div className="container">
            <ul className="footer-links" >
                ...
                <li className="footer-links__item"><a className="footer-links__link" href="http://expediadotcom.github.io/haystack/"><span className="ti-book"/> Documentation</a></li>
                {window.haystackUiConfig.enableSSO ? <li className="footer-links__item"><a className="footer-links__link" href="/auth/logout">Logout</a></li> : null}
            </ul>
